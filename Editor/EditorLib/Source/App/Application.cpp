...
void Application::attachModule(AppModule* const targetModule)
{
	if(!targetModule)
	{
...
void Application::detachModule(AppModule* const targetModule)
{
	if(!targetModule)
	{
		throw ModuleException(

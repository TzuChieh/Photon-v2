#include "EditorLib/Designer/IO/DesignerSceneWriter.h"
#include "EditorLib/ph_editor.h"
#include "EditorLib/Designer/DesignerScene.h"
#include "EditorLib/Designer/DesignerObject.h"
#include "EditorLib/Designer/IO/DesignerSceneMetaInfo.h"
#include "EditorLib/Designer/IO/DesignerDataPacketInterface.h"
...
void DesignerSceneWriter::write(const DesignerScene& scene)
{
	...
	Path sceneFile = getSceneWorkingDirectory() / (scene.getName() + ".pds");

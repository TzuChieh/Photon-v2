...
public class TaskStatusPanel
{
	...
	public TaskStatusPanel()
	{
		...
		m_panel.add(m_taskNameLabel, BorderLayout.NORTH);
		...
		m_panel.add(m_progressPanel, BorderLayout.CENTER);
		...
		m_panel.add(m_sampleFrequencyLabel, BorderLayout.SOUTH);
	}

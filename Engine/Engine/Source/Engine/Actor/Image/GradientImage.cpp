...
#include "Engine/Core/Texture/TLinearGradientTexture.h"
...
std::shared_ptr<TTexture<Image::NumericType>> GradientImage::genNumericTexture(
	const CookingContext& ctx)
{
	...
	return std::make_shared<TLinearGradientTexture<Image::NumericType>>(
		m_beginUvw, 

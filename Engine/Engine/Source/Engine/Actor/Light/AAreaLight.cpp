...
#include "Engine/Core/Emitter/DiffuseSurfaceEmitter.h"
#include "Engine/Core/Emitter/GroupedDiffuseSurfaceEmitter.h"
...
bool AAreaLight::isVolumetricEmissionSupported() const
{
	return false;
}

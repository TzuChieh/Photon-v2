...
#include "Engine/DataIO/FileSystem/CoreResource.h"
...
private:
	...
	math::Spectrum m_energyScale;

	LbLayer        m_layer0, m_layer1;

	real           m_cosWi;
	math::Spectrum m_R0i,  m_Ri0,  m_T0i,  m_Ti0;
...
inline const math::Spectrum& InterfaceStatistics::getEnergyScale() const
{

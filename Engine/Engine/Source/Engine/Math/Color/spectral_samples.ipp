...
#include "Engine/Math/General/TVectorN.h"
#include "Engine/Math/Color/spectral_data.h"
#include "Engine/Math/Physics/black_body.h"
#include "Engine/Math/math_exceptions.h"

...
{
	std::string text1;
	bool isLoaded = ph::TextFileLoader::load(EngineTestResourcePath("Text/simple_text.txt"), &text1);
...
{
	BinaryFileReader reader1(EngineTestResourcePath("Binary/test_binary_ascii.dat"));
	...
	BinaryFileReader reader2(EngineTestResourcePath("Binary/test_binary_hex.dat"));

...
class TSdlGenericColor : public TSdlReference<ETypeCategory::REF_IMAGE, Image, Owner>
{
private:
...
template<typename Owner>
inline TSdlGenericColor<Owner>::TSdlGenericColor(std::string valueName, std::shared_ptr<Image> Owner::* const imagePtr) :

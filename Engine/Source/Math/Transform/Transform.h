...
public:
	...
	// Notice that transforming a ray will neither change its parametric length (t) nor renormalizing its direction
	...
	// 
	// this operation will still yield a correctly transformed result while saving an expensive sqrt() call.

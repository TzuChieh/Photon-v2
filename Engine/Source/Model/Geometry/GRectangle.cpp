...
void GRectangle::discretize(std::vector<Triangle>* const out_triangles, const Model* const parentModel) const
{
	...
	out_triangles->push_back(Triangle(parentModel, vA, vB, vD));
	out_triangles->push_back(Triangle(parentModel, vB, vC, vD));
}

...
public:
	...
	virtual float32 calcDirectPdfW(const Vector3f& targetPos, const Vector3f& emitPos, const Vector3f& emitN, const Emitter* hitEmitter, const Primitive* hitPrim) const override;

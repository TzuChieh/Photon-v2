...
- Write skill instructions for agent execution: expose triggers, ordered actions, safety gates, and
  verification; omit human onboarding and generic engineering explanation.

...
for case_name, output_name, scene_name, num_threads, ref_path, visual_error_verifier, max_mse, max_rel_mean in [
    ("Quad (BVPT, ASCII)", "quad_bvpt_ascii", "quad_bvpt_ascii.p2", 6, quad_ref_path, quad_visual_error_verifier, 0.000074, 0.002),
    ("Quad (BVPT)", "quad_bvpt", "quad_bvpt.p2", 6, quad_ref_path, quad_visual_error_verifier, 0.000074, 0.002),
    ("Quad (BNEEPT, ASCII)", "quad_bneept_ascii", "quad_bneept_ascii.p2", 6, quad_ref_path, quad_visual_error_verifier, 0.000074, 0.002),
    ("Quad (BNEEPT)", "quad_bneept", "quad_bneept.p2", 6, quad_ref_path, quad_visual_error_verifier, 0.000074, 0.002),
    ("Quad (SPPM)", "quad_sppm", "quad_sppm.p2", 6, quad_ref_path, quad_visual_error_verifier, 0.0014, 0.01),
    ("Suzanne (BVPT)", "suzanne_bvpt", "suzanne_bvpt.p2", 12, suzanne_ref_path, suzanne_visual_error_verifier, 0.00007, 0.001),
    ("Suzanne (BNEEPT)", "suzanne_bneept", "suzanne_bneept.p2", 12, suzanne_ref_path, suzanne_visual_error_verifier, 0.00007, 0.001),
    ("Suzanne (SPPM)", "suzanne_sppm", "suzanne_sppm.p2", 12, suzanne_ref_path, suzanne_visual_error_verifier, 0.0002, 0.01)
    ]:

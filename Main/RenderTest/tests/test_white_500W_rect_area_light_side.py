...
diffuse_ref_path = res_dir / "ref_bvpt_diffuse_sphere_131072spp"
glass_ref_path = res_dir / "ref_bvpt_glass_sphere_131072spp"
...
for case_name, output_name, scene_name, ref_path, visual_error_verifier, max_mse, max_rel_mean in [
    ("BVPT Diffuse Sphere", "bvpt_diffuse_sphere", "scene_bvpt_diffuse_sphere.p2", diffuse_ref_path, diffuse_visual_error_verifier, 0.00048, 0.0004),
    ("BNEEPT Diffuse Sphere", "bneept_diffuse_sphere", "scene_bneept_diffuse_sphere.p2", diffuse_ref_path, diffuse_visual_error_verifier, 0.00122, 0.00068),
    ("BVPT Glass Sphere", "bvpt_glass_sphere", "scene_bvpt_glass_sphere.p2", glass_ref_path, glass_visual_error_verifier, 0.00054, 0.00064),
    ("BNEEPT Glass Sphere", "bneept_glass_sphere", "scene_bneept_glass_sphere.p2", glass_ref_path, glass_visual_error_verifier, 0.00058, 0.00064)
    ]:

...
Kebab Case). The helper will make the SDL name capitalized and separated by spaces.
*/
std::string sdl_name_to_title_case(std::string_view sdlName);

std::string sdl_name_to_camel_case(std::string_view sdlName, bool capitalizedFront = false);

std::string sdl_name_to_snake_case(std::string_view sdlName);

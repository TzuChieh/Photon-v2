...
xcopy %VS_SOLUTION_DIR%x64\Release\Engine.dll %ENGINE_BUILD_OUTPUT_DIR%Lib\ /e /y /i /r
xcopy %VS_SOLUTION_DIR%x64\Release\Engine.lib %ENGINE_BUILD_OUTPUT_DIR%Lib\ /e /y /i /r